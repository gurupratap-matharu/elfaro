# Generated by Django 3.2.3 on 2021-06-18 23:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(help_text='The name of the subject', max_length=255, verbose_name='Subject name')),
                ('active', models.BooleanField(default=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('groups', models.ManyToManyField(to='classroom.SubjectGroup')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teachers', models.ManyToManyField(to='classroom.Teacher')),
            ],
            options={
                'verbose_name': 'Course',
